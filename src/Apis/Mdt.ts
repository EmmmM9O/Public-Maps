...
export class Call {
    ...
    public static effect(_effect: Effect, _x: number, _y: number, _r: number, _color: Color) {
...
export namespace Administration {
    ...
    export class ActionFilter {
        public allow(action: PlayerAction): boolean {
            return true;
        }
    }
}
...
export class Timer {
    public static schedule(_run: () => void, _delaySeconds: number, _intervalSeconds: number) {
...
export function extend<T1, T2>(father: Class<T1>, _addon: (Partial<T1> & T2)): T1 {
    return new father;
}
...
export class Units {
    public static nearby(_team: Team, _x: number, _y: number, _r: number, _run: (u: UnitEntity) => void) {
...
export class Liquid {
    public static water: Liquid; public static slag: Liquid; public static oil: Liquid; public static cryofluid: Liquid; public static
        arkycite: Liquid; public static gallium: Liquid; public static neoplasm: Liquid; public static
        ozone: Liquid; public static hydrogen: Liquid; public static nitrogen: Liquid; public static cyanogen: Liquid;
}
export class StringBuilder {
    public str(): string {return "";}
}
...
export class Integer {
    public static parserInt(str: string): number {
        return 0;
    }
}
